...
public class App {
	...
	Comparator<Data<Integer, String>> COMPARE_KEY = new Comparator<Data<Integer, String>>() {
		...
		Comparator<Data<Integer, String>> COMPARE_NAME_LENGHT = new Comparator<Data<Integer, String>>() {
		...
		Set<Data<Integer,String>> set=new TreeSet<>(COMPARE_NAME_LENGHT);
		
		set.add(new Data<Integer, String>(5,"med"));
		set.add(new Data<Integer, String>(2,"samar"));
		set.add(new Data<Integer, String>(3,"kenzaa"));
		set.add(new Data<Integer, String>(1,"emna"));
		
		for(Data<Integer, String> name:set) {
